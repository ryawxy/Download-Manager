...
func main() {
	...
	for {
		fmt.Print("Enter command (create <queue_name> <max_concurrent_downloads> <start_time> <end_time> <directory> <bandwidthlimit> / edit <queue_name> <max_concurrent_downloads> <start_time> <end_time> <bandwidth_limit> / delete <queue_name> / list / done): ")
